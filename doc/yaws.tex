...
\item       \verb+<extra_response_headers> ... </extra_response_headers>+ ---
              ...
              response headers for this server, where
              '\verb+Header = Value+' directives can be
              specified. Each such response header and value is
              appended to all outgoing responses except for those
              returned directly by any \verb+DispatchModule+.
\end{itemize}
