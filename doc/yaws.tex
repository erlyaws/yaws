...
documentation of your Erlang/OTP releas for details.
...
\item        \verb+sni = disable | enable | strict+ ---
              ...
              mandatory too). Note that the first virutal server (the default
...
\end{verbatim}
                 ...
                 \item \verb+require_sni = true | false+ ---
                   ...
                   group). This directive is ignored is SNI support is disabled
                   (or not supported).
