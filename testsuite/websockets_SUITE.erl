...
-export([
    valid_opening_handshake/1,
    bad_version_handshake/1,
    bad_origin_handshake/1,
    noconnection_handshake/1,
    bad_connection_handshake/1,
    noupgrade_handshake/1,
    bad_upgrade_handshake/1,
    basic_unfragmented_text/1,
    advanced_unfragmented_text/1,
    basic_unfragmented_binary/1,
    advanced_unfragmented_binary/1,
    basic_ping_text/1,
    advanced_ping_text/1,
    basic_ping_binary/1,
    advanced_ping_binary/1,
    toolong_payload_ping/1,
    basic_unsolicited_pong/1,
    advanced_unsolicited_pong/1,
    basic_unsolicited_pong_ping_pong/1,
    advanced_unsolicited_pong_ping_pong/1,
    basic_10_pings/1,
    advanced_10_pings/1,
    badrsv_text/1,
    badrsv_binary/1,
    ...
    badrsv_complex/1,
    badopcodes/1,
    basic_fragmented_empty/1,
    basic_fragmented_text_1/1,
    basic_fragmented_binary_1/1,
    basic_fragmented_text_2/1,
    basic_fragmented_binary_2/1,
    basic_fragmented_ping/1,
    basic_fragmented_pong/1,
    basic_fragmented_close/1,
    basic_fragmented_text_with_ping/1,
    basic_fragmented_text_with_pong/1,
    basic_badfragmented_1/1,
    basic_badfragmented_2/1,
    basic_badfragmented_nocontinuation/1,
    advanced_fragmented_empty/1,
    advanced_fragmented_text_1/1,
    advanced_fragmented_binary_1/1,
    advanced_fragmented_text_2/1,
    advanced_fragmented_binary_2/1,
    advanced_fragmented_ping/1,
    advanced_fragmented_pong/1,
    advanced_fragmented_close/1,
    advanced_fragmented_text_with_ping/1,
    advanced_fragmented_text_with_pong/1,
    advanced_badfragmented_1/1,
    advanced_badfragmented_2/1,
    advanced_badfragmented_nocontinuation/1,
    basic_unfragmented_valid_utf8_text/1,
    basic_fragmented_valid_utf8_text/1,
    advanced_unfragmented_valid_utf8_text/1,
    advanced_fragmented_valid_utf8_text/1,
    basic_unfragmented_invalid_utf8_text/1,
    basic_fragmented_invalid_utf8_text/1,
    advanced_unfragmented_invalid_utf8_text/1,
    advanced_fragmented_invalid_utf8_text/1,
    basic_2_closes/1,
    basic_close_ping/1,
    basic_close_text/1,
    basic_fragtext_close_fragtext/1,
    basic_close_empty/1,
    basic_close_toosmall/1,
    basic_close_statusonly/1,
    basic_close_with_reason/1,
    basic_close_limit_size/1,
    basic_close_toolong/1,
    basic_close_invalid_utf8/1,
    basic_close_valid_codes/1,
    basic_close_invalid_codes/1,
    advanced_2_closes/1,
    advanced_close_ping/1,
    advanced_close_text/1,
    advanced_fragtext_close_fragtext/1,
    advanced_close_empty/1,
    advanced_close_toosmall/1,
    advanced_close_statusonly/1,
    advanced_close_with_reason/1,
    advanced_close_limit_size/1,
    advanced_close_toolong/1,
    advanced_close_invalid_utf8/1,
    advanced_close_valid_codes/1,
    advanced_close_invalid_codes/1,
    close_timeout/1,
    keepalive_timeout/1,
    too_big_frame/1,
    too_big_message/1,
    close_unmasked_frame/1
]).
-export([
    secure_websocket/1
]).
